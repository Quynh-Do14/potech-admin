...
export const privateRoutes = [
    ...
    {
        path: ROUTE_PATH.CHARACTERISTIC_MANAGEMENT,
        component: CharacteristicListPage,
        private: true,
        role: ["ADMIN", 'SELLER']
    },
    {
        path: ROUTE_PATH.ADD_CHARACTERISTIC_MANAGEMENT,
        component: AddCharacteristicManagement,
        private: true,
        role: ["ADMIN", 'SELLER']
    },
    {
        path: ROUTE_PATH.VIEW_CHARACTERISTIC_MANAGEMENT,
        component: EditCharacteristicManagement,
        private: true,
        role: ["ADMIN", 'SELLER']
    },
