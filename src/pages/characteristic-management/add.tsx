...
const AddCharacteristicManagement = () => {
    ...
    const onCreateAsync = async () => {
        ...
        if (isValidData()) {
            try {
                await characteristicService.AddCharacteristicAdmin({
...
export default AddCharacteristicManagement